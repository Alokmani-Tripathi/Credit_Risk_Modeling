...
st.markdown(
    """
    This application evaluates a borrower using:

    • **Logistic Regression (Champion)** – Interpretable  
    • **XGBoost (Challenger)** – Non-linear  
...
# ============================================================
# LOAD LR MODEL (FOR DEBUG + REASON CODES)
# ============================================================
...
borrower["fico_range_low"] = borrower["fico"]
...
# ✅ IMPORTANT FIX (previously missing)
borrower["mo_sin_old_rev_tl_op"] = numeric_input(
    "Months Since Oldest Revolving Trade",
    120, 0, 600
)
...
borrower["tot_cur_bal"] = numeric_input(
    "Total Current Balance", 50000, 0, 1_000_000
)
...
if st.button("🚀 Evaluate Borrower", use_container_width=True):
    ...
    st.subheader("🔎 DEBUG – LR Expected Feature Order")
